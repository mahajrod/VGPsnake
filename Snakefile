...
if "filter_reads" in config["stage_list"]:
    results_list += [expand(output_dict["data"] / ("fastq/hifi/filtered/{fileprefix}%s" % config["fastq_extension"]),
                             ...
                             *[[expand(output_dict["kmer"] / "{datatype}/{stage}/{datatype}.{stage}.{kmer_length}.{kmer_tool}.L{low_boundary}.U{upper_boundary}_smudgeplot.png",
                                    low_boundary=parameters["tool_options"]["smudgeplot"]["lower_boundary"],
                              ...
                              *[[expand(output_dict["kmer"] / "{datatype}/{stage}/{datatype}.{stage}.{kmer_length}.meryl.L{min_lower_boundary}.U{max_upper_boundary}.extracted.kmer.gz",
                                        min_low_boundary=[min(parameters["tool_options"]["smudgeplot"]["lower_boundary"])],
