...
results_dict["hic_scaffolding"] = [*results_dict["purge_dups"],
                                   ...
                                   expand(out_dir_path  / ("hic_scaffolding/{assembler}/{haplotype}/alignment/%s.{assembly_stage}.{assembler}.{haplotype}.bwa.filtered.rmdup.bed"  % config["genome_name"]),
                                          assembly_stage=["hic_scaffolding"],
                                          haplotype=[primary_haplotype, alternative_haplotype],
                                          assembler=assembler_list,),
                                   expand(out_dir_path / ("hic_scaffolding/{assembler}/{haplotype}/alignment/%s.map.{assembler}.{haplotype}.{resolution}.{ext}" % config["genome_name"]),
                                          haplotype=[primary_haplotype, alternative_haplotype],
                                          assembler=assembler_list,
