rule hifiasm: # TODO: implement modes without hic data
    ...
    params:
        ...
        N=lambda wildcards: " -N {0} ".format(parameters["tool_options"]["hifiasm"][wildcards.contig_options]["N"]) if "N" in parameters["tool_options"]["hifiasm"][wildcards.contig_options] else "",
